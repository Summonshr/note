...
<body style="position:relative">
    ...
    <form class="pdf" action="{{url()->current().'/mail'}}">
        <input class="pdf" style="color:black;background: #ffffff;height: 40px;right: 95px;" name="mail" placeholder="email"
            title="Type your email and hit enter to send this note in email" />
    </form>
    ...
    <script defer>
        ...
        window.onkeydown = function (e) {
            e.ctrlKey && e.key == 's' && event.preventDefault();
        }
